...
La cosmolog\'ia, del griego $\kappa o \sigma \mu o \lambda o \gamma \iota \alpha$  (\textcolor{c3}{$\kappa \acute{o}\sigma \mu o \zeta$} -cosmos, orden- y \textcolor{c3}{$\lambda o \gamma \iota \alpha$} - log\'ia, tratado, estudio) o es la rama de la astronomía que estudia el universo en conjunto. \\
...
generalmente referida como \Textit{Energía Oscura}. Se estima que la energía oscura contribuye con aproximadamente el 73\% de la densidad de energía total del Universo. Del resto, el 22\% corresponde a materia no relativista, que no interactúa electromagn\'eticamente, llamada \Textit{Materia Oscura} y solo un 5\% de materia ordinaria (bariónica). \\

\begin{figure}[!h]
\includegraphics[width=\textwidth]{images/Cosmological_composition.jpg}
\caption{Composici\'on del universo.}
\end{figure}
