\documentclass[xcolor=pdftex, x11names,table, oneside,11pt]{article}
\usepackage{natbib}
...
%\usepackage{etoolbox}
\usepackage[citecolor=c5]{hyperref}
\usepackage{rotating}
\usepackage{float}
...
\newcommand{\epigraphrulecolor}{c6}
\makeatletter
...
\definecolor{c2}{HTML}{1A829A}
\definecolor{c3}{HTML}{1B6C88}
\definecolor{c4}{HTML}{B9D2D4}
\definecolor{c5}{HTML}{E43C36}
\definecolor{c6}{HTML}{E7EAEA}
