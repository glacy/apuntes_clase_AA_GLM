...
%  \color{c1}{\hrule width .45\textwidth height 1pt}
  \begin{tikzpicture}[]
    ...
    \node (s5) at (4, 0) {};
    % sketch
    \draw [test={.5pt}{c1}{c2}, thick] (s1.center) to (s2.center);
    \draw [test={.5pt}{c2}{c3}, thick] (s2.center) to (s3.center);
    \draw [test={.5pt}{c3}{c4}, thick] (s3.center) to (s4.center);
    \draw [test={.5pt}{c4}{c5}, thick] (s4.center) to (s5.center);
\end{tikzpicture}
  \kern 2pt
}

\hyphenation{con-si-de-rar-se re-a-li-dad}
